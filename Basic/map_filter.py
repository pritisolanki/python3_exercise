...
filter_result = filter(
    lambda ele: ele["species"] == "crab", map(lambda x: x, aquarium_creatures)
)
print(list(filter_result))
# filter based on key and value
aquarium_species = filter(
    lambda ele, search_key="species", search_val="crab": ele[search_key] == search_val,
