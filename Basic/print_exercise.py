...
cities = ['Bangalore','Delhi','Mumbai','Ahmedabad','Shimla','Udaipur','Agra','Delhi']
names = ['Raj','Simran','Ajay','Vijay','Varun','Arjun','Rani','Anu']
age = [14,12,15,20,21,13,21,11]
likes = ['Hiking, Swimming', 'Walking','Coding','Singing, Dancing','Programming','Dancing','Hiking','Coding']
